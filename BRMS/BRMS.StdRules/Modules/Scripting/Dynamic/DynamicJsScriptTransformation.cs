...
public abstract class DynamicJsScriptTransformation : JsDynamicScriptRule, IDataTransform
{
    /// <summary>
    /// Constructor interno para crear instancias dinámicas
    /// </summary>
    public DynamicJsScriptTransformation()
    {
    }
    ...
    public override void Configure(DynamicRuleConfiguration ruleConfig, JObject? values)
    {
        ...
        OutputType = values?.Value<JsonSchema>("outputType") ?? new JsonSchema();
    }
    ...
    protected override void AddCustomParameters(IDictionary<string, object?> customParameters)
    {
        ...
        customParameters.Add("outputType", OutputType);
    }
